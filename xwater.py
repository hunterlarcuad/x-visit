...
class XVisit():
    ...
    def xvisit_run(self):
        ...
        self.inst_dp.args.extension_id = f'{EXTENSION_ID_YESCAPTCHA},{EXTENSION_ID_CAPMONSTER}'
...
"""
# noqa
python xwater.py --auto_like --auto_appeal --sleep_sec_min=30 --sleep_sec_max=60 --loop_interval=60
python xwater.py --auto_like --auto_appeal --sleep_sec_min=600 --sleep_sec_max=1800 --loop_interval=180
python xwater.py --auto_like --auto_appeal --sleep_sec_min=60 --sleep_sec_max=180
python xwater.py --auto_like --auto_appeal --sleep_sec_min=120 --sleep_sec_max=360
python xwater.py --auto_like --auto_appeal --sleep_sec_min=180 --sleep_sec_max=360 --headless

python xwater.py --auto_like --auto_appeal --profile=g05
python xwater.py --auto_like --auto_appeal --force --profile=g05

python xwater.py --auto_like --manual_exit --profile=g05

python xwater.py --auto_like --auto_appeal --force --headless --profile=t33

python xwater.py --auto_like --auto_appeal --force --headless --no_auto_vpn --profile=g02
python xwater.py --auto_like --auto_appeal --force --no_auto_vpn --profile=g02
"""
